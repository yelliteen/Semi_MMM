...
<script type="text/javascript" src="/sm/js/HuskyEZCreator.js"
		...
		<table width="100%">
			<tr>
				<td><input type="text" id="title" name="title"
					style="width: 1100px; height: 30px;" placeholder="제목을 입력하세요." /></td>
			</tr>

			<tr>
				<td><textarea rows="10" cols="30" id="ir1" name="content"
						style="width: 1100px; height: 400px;" placeholder="내용을 입력하세요."></textarea>
				</td>
			</tr>
		</table>
