...
<script>
    ...
    function scrollFunction() {
        if (document.body.scrollTop > 80 || document.documentElement.scrollTop > 80) {
            ...
            document.getElementById("login_span").style.fontSize = "17px";
            document.getElementById("join_span").firstChild.style.fontSize = "17px";
        } else {
            document.getElementById("navbar").style.padding = "20px 10px";
            document.getElementById("login_span").style.fontSize = "20px";
            document.getElementById("join_span").firstChild.style.fontSize = "20px";
        }
    }
    /*메뉴 등장*/
    function openNav() {
    ...
    var images = ['logo1.png', 'logo2.png', 'logo3.png', 'logo4.png', 'logo5.png', 'logo6.png'];
    $(function() {
