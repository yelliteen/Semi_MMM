...
<body class="sb-nav-fixed">
	...
	<a class="navbar-brand" href="index.html" style="height: 100%"><img
				...
				<div class="nav">
					...
					<div class="collapse" id="collapseLayouts"
						...
						<nav class="sb-sidenav-menu-nested nav"> <a class="nav-link"
							href="layout-static.html">게시글 관리</a> <a class="nav-link"
							href="layout-sidenav-light.html">댓글 관리</a> </nav>
					</div>
					<a class="nav-link collapsed" data-toggle="collapse"
					...
					<div class="collapse" id="collapsePages"
						...
						<nav class="sb-sidenav-menu-nested nav accordion"
							...
							href="layout-static.html">질문 관리</a> <a class="nav-link"
							href="layout-sidenav-light.html">응답 관리</a> </nav>
					</div>
					<a class="nav-link collapsed" data-toggle="collapse"
