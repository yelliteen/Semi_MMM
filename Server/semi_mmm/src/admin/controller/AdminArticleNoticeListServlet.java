 ...
 */
@WebServlet(name = "AdminArticleNoticeList", urlPatterns = { "/adminArticleNoticeList" })
public class AdminArticleNoticeListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminArticleNoticeListServlet() {
        super();
