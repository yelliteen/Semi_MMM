 ...
 */
@WebServlet(name = "ShopPageMain", urlPatterns = { "/shopPageMain" })
public class ShopPageMainServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShopPageMainServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Member m = new MemberService().selectOneMember(shopId);
		String ph1 = null;
		String ph2 = null;
		String ph3 = null;
		...
		request.getRequestDispatcher("/WEB-INF/views/shop/shopPageMain.jsp").forward(request, response);
	}
